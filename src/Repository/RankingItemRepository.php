 ...
 */
#[AsRepository(entityClass: RankingItem::class)]
class RankingItemRepository extends ServiceEntityRepository
{
    ...
    public function save(RankingItem $entity, bool $flush = true): void
    {
    ...
    public function remove(RankingItem $entity, bool $flush = true): void
    {
     ...
     */
    /**
     * @param array<RankingItem> $entities
     */
